...
void play()
{
    cout<<"Make integer set: \nHow do you want to make your set: \nWrite 1 if you want to make integer set with segments \nWrite 2 if you want to make integer set with numbers \n";
    int flag=next();
    integer_set a;
    if (flag==1)
    {
    ...
    cout<<"Comands: push_int, push_segm, write, erase_int, erase_segm, find_int, find_segm, size, end.";
    while (true)
    {
        string s;
        cin>>s;
